...
class User(AbstractUser):
    ...
    phone_number = models.CharField(max_length=30)
    medical_information = models.ForeignKey(MedicalInformation, models.CASCADE, null=True)
    emergency_contact = models.ForeignKey(EmergencyContact, models.CASCADE, null=True)
...
class Appointment(models.Model):
    patient = models.ForeignKey(User, models.CASCADE, related_name='patient_appointments')
    doctor = models.ForeignKey(User, models.CASCADE, related_name='doctor_appointments')
